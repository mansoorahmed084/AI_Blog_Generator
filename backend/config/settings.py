...
import os
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-#f%hht-r0$*4ni40sbqi1*2w4b+vzzn09b6u*!a%$t6#us39bl')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

# Allow Elastic Beanstalk host and custom domain
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Local static files (if any)
]
